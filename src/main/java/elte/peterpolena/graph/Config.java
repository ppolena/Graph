...
public class Config {
	...
	public static final int frameWidth = (int) Math.round(screenWidth * 0.75);
	public static final int frameHeight = (int) Math.round(screenHeight * 0.85);
	...
	public static final int maxTimerDelay = 10000;
}
